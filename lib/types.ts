...
export const QA_AGENTS: Record<string, QAAgentMeta> = {
  'review-requirement': {
    ...
    icon: '🔍',
    desc: 'Rà soát đặc tả yêu cầu (Static Testing) & Thiết lập Tiêu chí nghiệm thu chuẩn BDD Gherkin (Given-When-Then)',
    stepOrder: 1,
    testingStandard: 'ISTQB Static Testing & Agile BDD Gherkin Standard',
  ...
  'test-plan': {
    ...
    icon: '📊',
    desc: 'Lập Kế hoạch & Chiến lược kiểm thử tổng thể (Scope, Test levels, Risk Matrix, Entry/Exit criteria, Schedule & Resources)',
    stepOrder: 2,
    testingStandard: 'IEEE 829 / ISO 29119 Master Test Plan Standard',
  ...
  'test-case': {
    ...
    stepOrder: 3,
    testingStandard: 'ISTQB Test Design (Equivalence Partitioning & Boundary Value Analysis)',
  ...
  'test-report': {
    ...
    icon: '📝',
    desc: 'Rút gọn danh mục kiểm thử hồi quy trước Release & Báo cáo tổng kết kết quả kiểm thử kèm Quyết định Go/No-Go',
    stepOrder: 4,
    testingStandard: 'ISO/IEC/IEEE 29119-3 & Risk-Based Regression Testing (RBT)',
